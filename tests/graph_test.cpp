...
TEST(graph, basic_graph_creation) {
    ...
    g1.insert(connection(1, 2, 0.1));
    g1.insert(connection(1, 3, 0.5));
    g1.insert(connection(1, 4, 1.2));
    g1.insert(connection(2, 7, 0.1));
    g1.insert(connection(2, 8, 0.5));
    g1.insert(connection(2, 9, 1.2));
    g1.insert(connection(0, 2, 1.4));
    g1.insert(connection(0, 9, 2.1));
    ...
    g2.insert(connection(1, 2, 0.1));
    g2.insert(connection(1, 3, 0.5));
    g2.insert(connection(1, 4, 1.2));
    g2.insert(connection(2, 7, 0.1));
    g2.insert(connection(2, 8, 0.5));
    g2.insert(connection(2, 9, 1.2));
    g2.insert(connection(0, 2, 1.4));
    g2.insert(connection(0, 9, 2.1));
