...
TEST(path, get_position_square) {
    ...
    auto v = p.get_position(1.5);
    ASSERT_NEAR(v[0], 400, 0.0001);
    ASSERT_NEAR(v[1], 250, 0.0001);
    ASSERT_NEAR(v[2], 0, 0.0001);

    v = p.get_position(3.5);
    ASSERT_NEAR(v[0], 100, 0.0001);
    ASSERT_NEAR(v[1], 250, 0.0001);
    ASSERT_NEAR(v[2], 0, 0.0001);
}
